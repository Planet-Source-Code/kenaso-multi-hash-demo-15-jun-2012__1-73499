...
' ***************************************************************************
  ...
  Public Const PGM_NAME              As String = "kiHash (tm) Demo"
...
'              Modified/documented
' ***************************************************************************
Public Sub SetProgressForeColor(ByRef lngPBarHwnd As Long, _
                                ByVal lngColor As Long)

    On Error GoTo SetProgressForeColor_Error

    ' Change progress color
    '
    ' Syntax:
    '   SetProgressForeColor ProgressBar.hwnd, RGB(205, 0, 0)  ' red
    SendMessage lngPBarHwnd, PBM_SETBARCOLOR, 0&, ByVal lngColor

SetProgressForeColor_CleanUp:
    On Error GoTo 0
    Exit Sub

SetProgressForeColor_Error:
    ErrorMsg MODULE_NAME, "SetProgressForeColor", Err.Description
    Resume SetProgressForeColor_CleanUp

End Sub

' ***************************************************************************
' Routine:       SetProgressBackColor
'
...
'              Modified/documented
' ***************************************************************************
Public Sub SetProgressBackColor(ByRef lngPBarHwnd As Long, _
                                 ByVal lngColor As Long)

    On Error GoTo SetProgressBackColor_Error
    ...
    '      .CancelError = True
    '      .ShowColor
    '      SetProgressBackColor ProgressBar.hwnd, .Color
    ' End With
    SendMessage lngPBarHwnd, PBM_SETBKCOLOR, 0&, ByVal lngColor

SetProgressBackColor_CleanUp:
    On Error GoTo 0
    Exit Sub

SetProgressBackColor_Error:
    ErrorMsg MODULE_NAME, "SetProgressBackColor", Err.Description
    Resume SetProgressBackColor_CleanUp
